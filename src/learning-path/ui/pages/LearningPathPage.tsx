...
import { GetLearningPath } from '../../useCases/GetLearningPath';
...
export const LearningPathPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const learningPathRepository = new LearningPathService();
        ...
        const fetchModules = async () => {
            try {
                ...
                const fetchedModules = await getLearningPathUseCase.execute({ businessId: idAsNumber });
