...
import { CreateBusiness } from "../useCases/CreateBusiness";
import { BusinessService } from "../BusinessService";
import { VisualSelector } from "../../shared/ui/components/VisualSelector";
...
export function BusinessForm() {
  ...
  const [formData, setFormData] = useState<Omit<CreateBusinessDTO, "userId">>({
    name: "",
    businessType: "",
    location: "",
    sizeId: 1,
  ...
  const handleSave = async (e: FormEvent) => {
    ...
    try {
      ...
      const dataToSave: CreateBusinessDTO = { ...formData, userId: 1 };
